...
:if ([:len [/ip address find interface="intnet" and address="192.168.199.11/24"]] = 0) do={
  :put "Adding IP 192.168.199.11/24 on interface 'intnet'"
  /ip address add address=192.168.199.11/24 interface="intnet"
}
